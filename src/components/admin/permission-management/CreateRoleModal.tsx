      ...
      <div className="relative z-[101] w-full max-w-2xl mx-4 bg-white rounded-xl shadow-xl border border-slate-200 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-800">Шинэ эрх нэмэх</h2>
              <p className="text-sm text-slate-500">Эрхийн мэдээлэл оруулах</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {/* Role Title Input */}
          <div>
            <label htmlFor="role-title" className="block text-sm font-medium text-slate-700 mb-2">
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-200">
          ...
          <Button onClick={onSubmit} disabled={creating || !formData.title.trim() || formData.permission_ids.length === 0}>
