    ...
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-slate-800 mb-2">
          Захиралын үнэмлэхний лавалгаа зургаар
        </h3>
        <p className="text-sm text-slate-600 mb-4">
          {isRequired
            ? "Захиралын үнэмлэхний лавалгаа зургийг оруулна уу (заавал)"
            : "Захиралын үнэмлэхний лавалгаа зургийг оруулна уу"}
        </p>
      </div>
      ...
      {imageUrl ? (
        <div className="relative border-2 border-dashed border-slate-300 rounded-lg p-6 bg-slate-50">
          <div className="flex items-center justify-center">
            <img
              src={imageUrl}
              alt="Захиралын үнэмлэхний лавалгаа"
        ...
        <div className="border-2 border-dashed border-slate-300 rounded-lg p-12 bg-slate-50">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Зураг оруулах {isRequired && <span className="text-red-500">*</span>}
            </p>
            {!readOnly && (
              <label>
                <input
